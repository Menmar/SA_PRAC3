...
public class ItemRepositoryImpl implements ItemRepository {
  ...
  public List<Item> findByProductId(Long productId) {
    ...
    return jpaRepository.findItemEntitiesByProduct(jpaProductRepository.getById(productId)).stream()
  ...
  public String createItem(Item item) {
    ...
    itemEntity.setProduct(
        jpaProductRepository.findById(item.getProductId()).orElseThrow(IllegalArgumentException::new));
