...
public class CategoryRESTController {
  ...
  public ResponseEntity<List<Category>> findCategoriesByCriteria(
      @NotNull FindCategoriesByCriteria findCategoriesCriteria) {
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified parent category " + findCategoriesCriteria.getParentId() + " does not exist.", e);
    }
  }
  ...
  public ResponseEntity<Long> createCategory(@RequestBody @NotNull @Valid CreateCategoryRequest createCategoryRequest) {
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified parent category " + createCategoryRequest.getParentCategoryId() + " does not exist.", e);
    }
  }
}
