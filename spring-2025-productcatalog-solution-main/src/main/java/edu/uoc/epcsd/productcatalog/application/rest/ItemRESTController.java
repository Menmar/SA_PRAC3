...
public class ItemRESTController {
  ...
  public ResponseEntity<Item> setOperationalItem(@PathVariable @NotBlank String serialNumber,
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified item serial number '" + serialNumber + "' does not exist.");
    }
  }
  ...
  public ResponseEntity<String> createItem(@RequestBody @NotNull @Valid CreateItemRequest createItemRequest) {
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified product id " + createItemRequest.getProductId() + " does not exist.", e);
    }
  }
}
