...
public class DigitalItemRESTController {
  ...
  public ResponseEntity<Long> addDigitalItem(@RequestBody @Valid CreateDigitalItemRequest createDigitalItemRequest) {
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified digital session ID " + createDigitalItemRequest.getDigitalSessionId() + " does not exist.", e);
    }
  }
  ...
  public ResponseEntity<Boolean> updateDigitalItem(@PathVariable @NotNull Long digitalItemId,
    ...
    try {
      ...
      digitalItemService.updateDigitalItem(digitalItemId, updateDigitalItemRequest.getDescription(),
          updateDigitalItemRequest.getLink(), updateDigitalItemRequest.getLat(), updateDigitalItemRequest.getLon());

      return new ResponseEntity<>(true, HttpStatus.OK);
    } catch (IllegalArgumentException e) {
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified ID " + digitalItemId + " does not exist.", e);
    }
  }
  ...
  public ResponseEntity<Boolean> setDigitalItemForReview(@PathVariable @NotNull Long digitalItemId) {
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified DigitalItem id " + digitalItemId + " does not exist.", e);
    }
  }
