...
public class DigitalSessionRESTController {
  ...
  public ResponseEntity<Long> createDigitalSession(
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified userId " + createDigitalSessionRequest.getUserId() + " does not exist.", e);
    }
  }

  @PostMapping("/updateDigital/{digitalSessionId}")
  public ResponseEntity<Boolean> updateDigitalSession(@PathVariable @NotNull Long digitalSessionId,
    ...
    try {
      ...
      digitalSessionService.updateDigitalSession(digitalSessionId, updateDigitalSessionRequest.getDescription(),
          updateDigitalSessionRequest.getLink(), updateDigitalSessionRequest.getLocation(),
          updateDigitalSessionRequest.getUserId());

      return new ResponseEntity<>(true, HttpStatus.OK);
    } catch (IllegalArgumentException e) {
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified Id or UserId " + digitalSessionId + " / " + updateDigitalSessionRequest.getUserId()
              + " does not exist.", e);
    }
  }
  ...
  public ResponseEntity<Boolean> removeDigitalSession(@PathVariable @NotNull Long digitalSessionId) {
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified DigitalSession id " + digitalSessionId + " does not exist.", e);
    }
  }
}
