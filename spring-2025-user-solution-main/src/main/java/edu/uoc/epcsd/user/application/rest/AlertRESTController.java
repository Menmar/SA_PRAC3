...
public class AlertRESTController {
  ...
  @ResponseStatus(HttpStatus.OK)
  public List<Alert> getAlertsByProductAndDate(@RequestParam @NotNull Long productId,
  ...
  @ResponseStatus(HttpStatus.OK)
  public List<Alert> getAlertsByUserAndInterval(@RequestParam @NotNull Long userId,
  ...
  public ResponseEntity<Long> createAlert(@RequestBody @Valid CreateAlertRequest createAlertRequest) {
    ...
    try {
      ...
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified userId " + createAlertRequest.getUserId() + " does not exist.", e);
    } catch (RestClientException e) {
      throw new ResponseStatusException(HttpStatus.BAD_REQUEST,
          "The specified productId " + createAlertRequest.getProductId() + " does not exist.", e);
    }
  }
}
